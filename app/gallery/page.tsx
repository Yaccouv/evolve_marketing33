...
export default function GalleryPage() {
  ...
  const galleryImages = [
    ...
    { src: "/placeholder.svg?height=300&width=400", alt: "Organic Manure Production", category: "Manure" },
    ...
    { src: "/placeholder.svg?height=300&width=400", alt: "Organic Fertilizer", category: "Manure" },
